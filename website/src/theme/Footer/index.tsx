                ...
                <div className="funding-notice">
                    ...
                    <div className="funding-text">
                        ...
                        <p>
                            ...
                            reflect the views of the European Union or the European Commission. Neither the European
                        ...
                        <div className="copyright">
                            ...
                            Metadata Renderer is a project developed by SAP to help ensure API guideline compliance. For
                            applicable policies including privacy policy, terms of use and trademark usage guidelines,
                            please see{' '}
